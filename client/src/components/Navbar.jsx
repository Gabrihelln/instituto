        ...
        </button>
        {
            ...
            {user?.token ? (
              ...
              <Link to='/sign-in'>
                <Button
                  label='Entrar'
                  styles='flex items-center justify-center bg-black dark:bg-blue-600 text-white dark:text-white text-white px-4 py-1.5 rounded-full'
                />
              </Link>
            )}
          </div>
            ...
            <div className='flex gap-2 items-center cursor-pointer'>
                {
                    user?.token ? ( 
                        ...
                        <span className='font-medium text-black dark:text-gray-600'>
                        ...
                        {showProfile && (
                            <div className='absolute bg-white dark:bg-[#2f2d30] py-6 px-6 flex flex-col shadow 2xl z-50 right-0 gap-3 rounded'>
                                ...
                                <span className='border-t border-slate-300 text-blue-700' onClick={handleSignOut}>
                                    Sair
                                </span>
                            </div>
                        )}
                    ...
                    <Link to='/sign-in'>
                        <Button
                            label="Entrar" styles="flex items-center justify-center bg-black dark:bg-blue-600 text-white dark:text-white px-4 py-1.5 rounded-full" />
                    </Link>
                )}
            </div>
        </div>
